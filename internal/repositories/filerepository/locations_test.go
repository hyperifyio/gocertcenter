...
func TestGetPrivateKeyPemPathWithTwoCertificates(t *testing.T) {
	a := models.NewSerialNumber(big.NewInt(123))
	b := models.NewSerialNumber(big.NewInt(456))
	dir := "/data"
	organization := "HangoverGames"
	certificates := []models.ISerialNumber{a, b}
...
func TestGetPrivateKeyPemPathWithOneCertificate(t *testing.T) {
	...
	dir := "/data"
	organization := "HangoverGames"
	certificates := []models.ISerialNumber{a}
