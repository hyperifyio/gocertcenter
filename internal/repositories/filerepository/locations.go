...
func GetPrivateKeyPemPath(dir, organization string, certificates []models.ISerialNumber) string {
...
func GetCertificatePemPath(dir, organization string, certificates []models.ISerialNumber) string {
