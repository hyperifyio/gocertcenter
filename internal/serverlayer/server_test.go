...
func TestServer_FinalizeSetup(t *testing.T) {
	...
	mockSwaggerManager := new(mocks.MockSwaggerManager)
	mockFactory := func(
		router *mux.Router,
...
func TestSetupHandlerEmptyMethodPath(t *testing.T) {
	...
	// Set up expectations
	// Assuming the default method is GET and default path is "/"
...
func nilServerFactory(address string, router *mux.Router) apitypes.IServerManager {
	return nil
}
...
func TestServer_StartWithShortDelayedServeFailure(t *testing.T) {
	...
	server.SetServerFactory(func(address string, router *mux.Router) apitypes.IServerManager {
...
func TestServer_SetSwaggerFactory(t *testing.T) {
	...
	mockSwaggerManager := &mocks.MockSwaggerManager{}

	// Mock factory function that returns an instance of our mockSwaggerManager
	factory := func(router *mux.Router, ctx *context.Context, url, description string, info *openapi3.Info) (apitypes.ISwaggerManager, error) {
		return mockSwaggerManager, nil
	}
...
func TestServer_StopShutdownFails(t *testing.T) {
	...
	mockServerManager := new(mocks.MockServerManager)
